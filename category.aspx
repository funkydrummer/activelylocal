	...
	<div id="wrapper">
		<div id="content">
			...
			<h1>Category Search Results</h1>
				...
				<asp:DataList id="DataList1" runat="server" DataSourceID="SqlDataSource2" CssClass="DataList1" CellPadding="4" ForeColor="#333333">
					<AlternatingItemStyle BackColor="White" />
					<FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
					<HeaderStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
					<ItemStyle BackColor="#FFFBD6" ForeColor="#333333" />
					<ItemTemplate>
						<h3><asp:Label id="BusinessNameLabel" runat="server" Text='<%# Eval("BusinessName") %>' /></h3>
						<br />
				...
				<asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Arvixe1 %>" SelectCommand="CategorySearch" SelectCommandType="StoredProcedure">
					<SelectParameters>
						<asp:QueryStringParameter DefaultValue="" Name="category" QueryStringField="category" Type="String" />
					</SelectParameters>
				</asp:SqlDataSource>
