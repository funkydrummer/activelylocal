...
<div id="outer">
	...
	<div id="wrapper">
		<div id="content">
			...
			<asp:CreateUserWizard runat="server" id="CreateUserWizard1" ContinueDestinationPageUrl="index.aspx" DisplayCancelButton="True" InvalidPasswordErrorMessage="Password length must be at least {0} characters and contain at least {1} non-alphanumeric character." CssClass="registeruser" BackColor="#F7F7DE" BorderColor="#CCCC99" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="10pt"> 
				<ContinueButtonStyle BackColor="#FFFBFF" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" ForeColor="#284775" />
				<CreateUserButtonStyle BackColor="#FFFBFF" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" ForeColor="#284775" />
				<TitleTextStyle BackColor="#6B696B" Font-Bold="True" ForeColor="#FFFFFF" />
				<WizardSteps> 
					<asp:CreateUserWizardStep runat="server" Title="Sign Up"/> <asp:CompleteWizardStep runat="server"/> </WizardSteps> 
		...
		<p class="footer-text">By clicking the Create User button, you agree to the <a href="terms.aspx">Terms of Service</a> and <a href="privacy.aspx">Privacy Policy.</a></p>	    
		<!-- #EndEditable -->
		</div>	
