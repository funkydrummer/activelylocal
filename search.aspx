	...
	<div id="wrapper">
		...
		<div id="content0">
			...
			<div id="search">
				...
				<asp:Button id="btnsearch2" runat="server" Text="Search" Width="75px" />
				...
				<asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Arvixe1 %>" SelectCommand="BusinessSearch" SelectCommandType="StoredProcedure">
					<SelectParameters>
