...
<head>
	...
	<title>Welcome to Innovation Evolved!</title>
	<!-- #EndEditable -->
...
<div id="outer">
	...
	<div id="wrapper">
		<div id="content">
			...
			<h1>Welcome to Innovation Evolved</h1>
	
			<h2><img src="images/new_york_city__2_140px.jpg" alt="New York" class="float-left">Events In New York</h2>
	          ...
	          <p> <a href="events.aspx?city=new-york">Events In New York City</a><br>
	          </p>
			<h2><img src="images/sanfrancisco3_140px.jpg" alt="San Francisco" class="float-left">Events 
			  in San Francisco</h2>
	          ...
	          <p> <a href="events.aspx?city=san-francisco">Events In San Francisco</a><br>
	          </p>
			<h2><img src="images/Seattle_Skyline_140px.jpg" alt="Seattle" class="float-left">Events 
			  in Seattle</h2>
	          ...
	          <p> <a href="events.aspx?city=seattle">Events In Seattle</a></p>
	          <p>&nbsp;</p>
	
			<h1>Reviews</h1>
		          <ul>
		            <li><a href="reviews.aspx">Take a look at all the latest reviews in your area.</a></li>
		            <li>Share with us that great jazz bar or that romantic restaurant. <a href="write-reviews.aspx">Write a Review</a></li>
		            <li>Get paid for your reviews! <a href="getpaid.html">Learn More</a></li>
		          </ul>
	          
			<h1>Editorials</h1>
	          <p> If you have plans for a quiet night out with close friends, a family reunion or a wild weekend on the town, we'll provide all the information you need to make it memorable. Our expert staff is always scouting the best places for excitement, value, and fun.</p>
	          <p>Send us your ideas for any places you want to see highlighted here. Share with us that great jazz bar or that romantic restaurant and we'll be sure to send someone to the scene to tell everyone about the details.</p>
	          <p><a href="editorials.aspx">Read More</a></p>
